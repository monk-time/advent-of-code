...
def test_trace_wire():
    ...
    assert trace_wire(wire1) == {(0, 0): 0, (0, 1): 1, (0, 2): 2,
                                 (1, 2): 3, (-1, 2): 5, (-2, 2): 6}
...
def test_find_min_intersection_by_steps():
    ...
    wire1, wire2 = parse('R75,D30,R83,U83,L12,D49,R71,U7,L72\n'
                         'U62,R66,U55,R34,D71,R55,D58,R83')
    assert find_min_intersection_by_steps(wire1, wire2) == 610
    wire1, wire2 = parse('R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51\n'
